      ...
      <div className="bg-cream min-h-screen">
        ...
        <div className="max-w-6xl mx-auto pt-16 px-4 lg:px-0 flex justify-center items-center h-64">
          <div className="text-center">
            <div className="text-lg font-medium text-darkGreen">
              Loading your cart...
            </div>
          </div>
        </div>
      ...
      <main className="max-w-6xl mx-auto pt-16 px-4 lg:px-0">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            ...
            >
              <div className="p-6">
                ...
                {/* Cart items */}
                {cartItems.map((item) => {
                  // Fix for error: Using proper product structure with variants array
                  const variant = item.product.variants?.find(
                    (v) => v.color === item.color
                  );
                  const sizeOption = variant?.sizeOptions?.find(
                    (s) => s.size === item.size
                  );

                  // Use item's stored price if available, otherwise get from size option
                  const price =
                    item.price || (sizeOption ? sizeOption.price : 0);
                  // Get available quantity from size option
                  const available = sizeOption ? sizeOption.quantity : 0;
          ...
          <div className="lg:w-1/3">
            <div
              style={{ backgroundColor: COLORS.white }}
              className="rounded-lg shadow-md sticky top-24"
            >
              <div className="p-6">
                <h2
                  style={{ color: COLORS.darkGreen }}
