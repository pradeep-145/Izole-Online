      ...
      setCartItems(
        cartItems.map((item) => {
          if (item.id === id) {
            ...
            const validQuantity = Math.max(1, Math.min(newQuantity, item.available));
    ...
    return (
      <div className="bg-gray-50 min-h-screen">
        ...
        <main className="max-w-6xl mx-auto pt-16 px-4 lg:px-0">
          <h1 className="text-3xl font-bold text-gray-800 mt-8 mb-6">Shopping Cart</h1>
            ...
            <div className="lg:w-2/3">
              <div className="card bg-white shadow-md">
                <div className="card-body p-6">
                  ...
                  {/* Cart items */}
                  {cartItems.map((item) => (
                    <div key={item.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 py-6 border-b last:border-0">
                ...
                <div className="card-body p-6">
                  ...
                  <div className="mt-4 bg-blue-50 p-4 rounded-lg flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      <p className="font-medium text-blue-800">Free shipping on orders over $100</p>
