...
const OtpVerification = () => {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      if (isFromLogin) {
        const res = await axios.post("https://uzlmegb12i.execute-api.ap-south-1.amazonaws.com/api/auth/confirm", {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      await axios.post("https://uzlmegb12i.execute-api.ap-south-1.amazonaws.com/api/auth/reset-password", {
        email,
        code: otp.join(''),
        password
      });
  ...
  const handleResendOtp = async () => {
    ...
    try {
      if (isFromLogin) {
        ...
        await axios.post("https://uzlmegb12i.execute-api.ap-south-1.amazonaws.com/api/auth/send-otp", { email });
      }
