    ...
    (set, get) => ({
      ...
      addToCart: async (item) => {
        ...
        try {
          ...
          if (existingItemIndex !== -1) {
            ...
            await axios.put(
              "https://uzlmegb12i.execute-api.ap-south-1.amazonaws.com/api/cart/update",
              {
            ...
            const response = await axios.post("https://uzlmegb12i.execute-api.ap-south-1.amazonaws.com/api/cart/add", item, {
              headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
                "Content-Type": "application/json",
              },
      ...
      removeFromCart: async (itemId, color, size) => {
        ...
        try {
          ...
          await axios.delete("https://uzlmegb12i.execute-api.ap-south-1.amazonaws.com/api/cart/remove", {
      ...
      fetchCart: async (forceRefresh = false) => {
        ...
        fetchPromise = new Promise((resolve) => {
          axios
            .get("https://uzlmegb12i.execute-api.ap-south-1.amazonaws.com/api/cart/get", {
              headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
                "Content-Type": "application/json",
              },
      ...
      clearCart: async () => {
        set({ isLoading: true, error: null });
        try {
          await axios.delete("https://uzlmegb12i.execute-api.ap-south-1.amazonaws.com/api/cart/clear", {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
              "Content-Type": "application/json",
            },
