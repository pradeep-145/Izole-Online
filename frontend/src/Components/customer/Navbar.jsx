...
const Navbar = () => {
  ...
  return (
    <div className={`navbar justify-between fixed top-0 w-full z-30 transition-all duration-300 ${scrolled ? 'py-2 shadow-md bg-mustard/50 text-wineRed' : 'py-4 bg-mustard/70 backdrop-blur-sm'}`}>
